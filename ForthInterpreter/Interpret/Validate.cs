...
public static class Validate
{
    ...
    {
        var wordName = ReadMandatoryWordName(env);
    ...
    {
        var instanceWord = ReadExistingWord(env) as InstanceWord;
    ...
    public static Word PopControlFlowStack(Environment env, bool countIsOne, string definingWordName = null, Type type = null)
    {
